...
function make_album(artistname: string, artisttitle: string,tracks: number=0): { artistname: string; artisttitle: string; tracks: number }
{
    const album = {
        artistname,
        artisttitle,
...
const album1 = make_album('Abidaperveen', 'Album 100');
const album2 = make_album('MehdiHassan', 'Album 200',5);
const album3 = make_album('Astad Nusrat Ali', 'Album 128',2);
